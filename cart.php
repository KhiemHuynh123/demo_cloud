...
?>
<div class="container">
    <h1 class="fw-bol mb-0 text-black">Shopping Cart</h1>
...
?>
    ...
    <hr class="my-4">
    <div class="pt-5">
        <h6 class="mb-0"><a href="homepage2.php" class="text-body"><i class="fas"
                    style="font-weight: 400px; font-size:larger;"><i>Back to shop</a></h6>
    </div>
</div>